...
# Form implementation generated from reading ui file 'D:\программы\1000ListNik\instagramm\design\5.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ok_img = QtWidgets.QPushButton(self.centralwidget)
        self.ok_img.setGeometry(QtCore.QRect(170, 10, 171, 171))
        self.ok_img.setStyleSheet("background: rdba(0,0,0,0);")
        self.ok_img.setText("")
        self.ok_img.setObjectName("ok_img")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.you_finish_ckecking_text.setText(_translate("MainWindow", "Вы прошли проверку"))
