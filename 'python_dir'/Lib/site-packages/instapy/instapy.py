...
from .commenters_util import my_get_nikName_comments_list
from .commenters_util import users_liked
from .commenters_util import get_photo_urls_from_profile
from .commenters_util import  my_get_count_likers
from .commenters_util import  check_acc_inst
...
class InstaPy:
    ...
    def check_acc_instagram(self, username):
        try:
            
            return check_acc_inst(self.browser, "https://www.instagram.com/" + username + '/')
        except Exception:
            return False
    def my_get_usernames_from_comments(self, herf, daysold=365):
        return [i[0] for i in my_get_nikName_comments_list(self.browser, herf, daysold) if i[1]]
    ...
    def my_get_count_likers(self, photo_url):
        return my_get_count_likers(self.browser, photo_url)
    
    def my_get_listLikerUser(self, photo_url, follow_likers_per_photo):
